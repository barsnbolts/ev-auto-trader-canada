...
If context feels bloated, reaches 40%, or before switching to low reasoning:
...
Zones:
- below 40%: normal, compact before handoff.
- 40-69%: safe area, compact immediately and avoid broad reads.
- 70%+: danger, stop expansion and resume from `.codex/safe-area.md`.
