...
- visual QA proof: `./script/build_and_run.sh --verify-ui` verifies launch and writes a main-display screenshot under `qa/` when macOS Screen Recording permission allows it.
...
- Use `--verify-ui` after UI/import-view changes or before taking screenshots for README.
