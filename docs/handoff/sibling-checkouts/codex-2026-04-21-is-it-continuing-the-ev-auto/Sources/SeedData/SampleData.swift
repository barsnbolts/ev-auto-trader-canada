...
public enum SampleData {
    ...
    public static let listings: [Listing] = [
        ...
        Listing(
            ...
            priceCAD: 57688,
            condition: .new,
            sourceURL: "https://www.downtownhyundai.com/model-research/ioniq-5/",
            confidence: .high
        ),
        Listing(
        ...
        Listing(
            ...
            priceCAD: 73800,
            condition: .new,
            sourceURL: "https://www.kia.ca/en/vehicles/ev9/2026/overview",
            confidence: .high
        )
    ]
    ...
    public static let dealLeverageCanonicalVehicles: [CanonicalVehicle] = [
        ...
        CanonicalVehicle(
            ...
            confidence: .low,
            provenance: [
                ProvenanceRecord(sourceName: "Hyundai Canada", detail: "Hybrid target-scope seed; update with official fuel economy rather than EV range.", sourceURL: "https://www.hyundaicanada.com/")
            ],
        ...
        CanonicalVehicle(
            ...
            confidence: .low,
            provenance: [
                ProvenanceRecord(sourceName: "Kia Canada", detail: "Hybrid target-scope seed; import official hybrid metrics later.", sourceURL: "https://www.kia.ca/")
            ],
    ...
    public static let incentivePrograms: [IncentiveProgram] = [
        IncentiveProgram(
            ...
            name: "EVAP / Federal ZEV Incentive (Official List Match)",
            kind: "Federal",
            jurisdiction: "Canada",
            applicableMakes: ["Hyundai", "Kia"],
            applicableModels: ["Kona EV", "EV4", "EV6", "Niro EV", "Niro PHEV", "Sorento PHEV", "Sportage PHEV"],
            maxAmountCAD: 5000,
            eligibilityNotes: "Transport Canada EVAP is active for transactions on or after 2026-02-16. Official list shows selected Hyundai/Kia BEV/PHEV trims; final transaction value, trim, lease term, dealer submission date, and funding must be verified immediately before negotiation.",
            sourceURL: "https://tc.canada.ca/en/road-transportation/innovative-technologies/electric-vehicles/electric-vehicle-affordability-program-evap/electric-vehicle-affordability-program-vehicle-list"
        )
    ]

    public static let inventoryListings: [InventoryListing] = [
        InventoryListing(
            id: "inventory-downtown-hyundai-ioniq5-26668d",
            canonicalVehicleID: "hyundai-ioniq5-preferred-awd-2026",
            vin: "KM8KRDDC6TU393795",
            stockNumber: "26668D",
            make: "Hyundai",
            model: "IONIQ 5",
            ...
            status: "In Stock",
            advertisedPriceCAD: 65649,
            msrpCAD: 65649,
            priceBreakdown: PriceBreakdown(msrpCAD: 65649, advertisedPriceCAD: 65649),
            sourceURL: "https://www.downtownhyundai.com/inventory/2026-hyundai-ioniq-5-preferred-Gpy5Id8mR0iZKwOoJa3yQQvdp/",
            sourceType: .dealer,
            confidence: .high,
            firstSeenAt: .now.addingTimeInterval(-4 * 86_400),
            lastSeenAt: .now,
            notes: ["Dealer page lists purchase price, stock 26668D, VIN KM8KRDDC6TU393795, and new condition.", "No seeded federal incentive applied; recheck current EVAP/OEM eligibility before negotiation."]
        ),
        InventoryListing(
            id: "inventory-mississauga-hyundai-tucson-hybrid-56898",
            canonicalVehicleID: "hyundai-tucson-hybrid-ultimate-awd-2026",
            vin: "KM8JCDD17TU429151",
            stockNumber: "56898",
            make: "Hyundai",
            model: "Tucson Hybrid",
            trim: "Ultimate AWD",
            ...
            status: "In Stock",
            advertisedPriceCAD: 49949,
            msrpCAD: 49949,
            priceBreakdown: PriceBreakdown(msrpCAD: 49949, advertisedPriceCAD: 49949),
            sourceURL: "https://www.mississaugahyundai.com/vehicles/2026/hyundai/tucson-hybrid/mississauga/on/68549715/print",
            sourceType: .dealer,
            confidence: .high,
            firstSeenAt: .now.addingTimeInterval(-5 * 30 * 86_400),
            lastSeenAt: .now,
            notes: ["Dealer print page lists final price, stock 56898, VIN KM8JCDD17TU429151, and new condition.", "No EVAP for HEV; use as electrified-stock comparison leverage only."]
        ),
        InventoryListing(
            id: "inventory-mississauga-hyundai-tucson-phev-56546",
            canonicalVehicleID: "hyundai-tucson-phev-ultimate-2026",
            vin: "KM8JDDD23TU422400",
            stockNumber: "56546",
            make: "Hyundai",
            ...
            odometerKm: 10,
            status: "In Stock",
            advertisedPriceCAD: 55449,
            msrpCAD: 55449,
            priceBreakdown: PriceBreakdown(msrpCAD: 55449, advertisedPriceCAD: 55449),
            sourceURL: "https://www.mississaugahyundai.com/vehicles/2026/hyundai/tucson-plug-in-hybrid/mississauga/on/68348817/print",
            sourceType: .dealer,
            confidence: .high,
            firstSeenAt: .now.addingTimeInterval(-5 * 30 * 86_400),
            lastSeenAt: .now,
            notes: ["Dealer print page lists final price, stock 56546, VIN KM8JDDD23TU422400, 10 km, and new condition.", "Tucson PHEV is not in the seeded official EVAP model list; require dealer confirmation before applying incentives."]
        ),
        InventoryListing(
            id: "inventory-kia-sportage-phev-dixie-2025-a",
            canonicalVehicleID: "kia-sportage-phev-ex-premium-2025",
            vin: "JWWDD5G1GEV2GG612",
            make: "Kia",
            model: "Sportage PHEV",
            trim: "EX Premium AWD",
            year: 2025,
            ...
            status: "In Stock",
            advertisedPriceCAD: 49438.50,
            msrpCAD: 50438.50,
            priceBreakdown: PriceBreakdown(msrpCAD: 50438.50, advertisedPriceCAD: 49438.50, manufacturerDiscountCAD: 1000),
            sourceURL: "https://www.401dixiekia.com/en/new-catalog/kia/2024-kia-sportage-phev-ex%20premium-id26554",
            sourceType: .dealer,
            confidence: .high,
            firstSeenAt: .now.addingTimeInterval(-6 * 30 * 86_400),
            lastSeenAt: .now,
            incentiveProgramIDs: ["incentive-evap-federal"],
            notes: ["Dealer page lists available-from price, original price, $1,000 manufacturer rebate, VIN JWWDD5G1GEV2GG612, and included fees.", "Original price is stored in the MSRP field for comparison only; verify MSRP on Kia Canada before negotiation.", "EVAP program match still requires dealer portal submission and final transaction-value confirmation."]
        )
    ]
    ...
    public static let researchBatches: [ResearchBatch] = [
        ResearchBatch(
            ...
            prompt: "Imported-style source-backed GTA batch seeded from public dealer/OEM pages; regenerate from Research Prompt view before live shopping.",
