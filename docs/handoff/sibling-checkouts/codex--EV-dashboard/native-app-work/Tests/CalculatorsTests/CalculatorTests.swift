...
struct CalculatorTests {
    ...
    func leverageCalculatorPrioritizesDealerWeaknessSignals() throws {
        ...
        #expect(top.listing.id == "inventory-hyundai-ioniq5-downtown-2025-a")
        #expect(top.score.dealerWeakness > 50)
        #expect(top.score.reasons.contains { $0.localizedCaseInsensitiveContains("leftover") })
    }
...
final class CalculatorTests: XCTestCase {
    ...
    func testLeverageCalculatorPrioritizesDealerWeaknessSignals() throws {
        ...
        XCTAssertEqual(top.listing.id, "inventory-hyundai-ioniq5-downtown-2025-a")
        XCTAssertGreaterThan(top.score.dealerWeakness, 50)
        XCTAssertTrue(top.score.reasons.contains { $0.localizedCaseInsensitiveContains("leftover") })
    }
