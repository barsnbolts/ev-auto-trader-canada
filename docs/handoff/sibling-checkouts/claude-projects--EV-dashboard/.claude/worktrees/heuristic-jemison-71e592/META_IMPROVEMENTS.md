> ## ⚠️ Superseded 2026-04-23 (Cluster A)
>
> Items absorbed into `AUTONOMOUS_PLAN.md` queue (I-05 CHANGELOG, I-08 health dashboard, I-10 screenshot archive, I-13 auto-memory backup) and into `specs/cluster-A-foundation.md` (A1 memory / A2 ritual extension / A6 queue.py / A7 validate.py / A10 Vitest / A11 smoke.sh / A14 self_audit.py / A15 hooks / A16 Zod).
>
> **Do not act on this document directly.** The game plan at `.claude/plans/this-project-was-being-gentle-adleman.md` and the Cluster A spec are the live sources of truth. This doc is retained only for historical context — see the "top-15 changes" table to understand the reasoning that fed into the game plan.
