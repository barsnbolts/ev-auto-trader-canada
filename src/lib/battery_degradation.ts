...
// Ported verbatim from sibling EV dashboard src/lib/battery_degradation.ts.
...
// Match the union in SpecSchema — avoids importing zod-inferred type
...
export function projectedRangeAtYear(
  ratedRangeKm: number,
